...
Suponga que en su proyecto tiene una base de datos llamada "Empresas" (formato xlsx) y dicha base está en una carpeta llamada "Datos"; escriba el código necesario para importar la base de datos.Recuerde llamar la librería antes de usar la función y, nombrar la base de datos como cargada como "Empresas".
...
library("readxl") # Recuerde siempre llamar antes la librería 
Empresas=read_excel("Datos/Empresas.xlsx")
Empresas
```
